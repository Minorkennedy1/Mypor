...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Minorkennedy1" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/kennedy-minor-32722a3a0/" },
  { icon: Instagram, link: "https://www.instagram.com/peanut6_9/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  "Creating an Innovative, Functional, and User-Friendly Website for Digital Solutions."                </p>
